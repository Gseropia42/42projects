...
/*   Updated: 2016/01/19 21:57:01 by gseropia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libftprintf.h"

int	lastcheck_long_long_base(char *s, unsigned long long nbr, sdp_list *stock)
{
	int ret;
	ret = 0;
	if (stock->precision)
...
int	check_l_l_diese(sdp_list *stock)
{
	write(1, "0", 1);
	if (stock->fonction == 'x')
		write(1, "x", 1);
...
int	checkrelou_long_long_base(char *s, unsigned long long nbr, sdp_list *stock)
{
	int ret;
...
int	easyflags_long_long_base(char *s, unsigned long long nbr, sdp_list *stock)
{
	int ret;
